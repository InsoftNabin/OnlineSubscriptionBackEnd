...
namespace OnlineSubscriptionBackEnd.Controllers.Insoft
{
    ...
    public class CustomerController : Controller
    {
        ...
        public JsonResult InsertUpdateCustomer([FromBody] Customer ai)
        {
            try
            {
                ...
                SqlParameter[] parm = {
                        ...
                        new SqlParameter("@GUID",ai.UniqCustomerKey),                            /// unique customer key generated by our encryption Algorithm
        ...
        [HttpPost]
        public ActionResult getSubsbyCusandProductIdAdminInsoft([FromBody] CustomerwiseModules p)
        {
            try
            {
                SqlParameter[] parm = {
                ...
                string data = dh.ReadToJson("[Insoft_S_CustomerandProductSubscriptionTypeAdmin]", parm, CommandType.StoredProcedure);
                return Ok(data);
            }
            catch (Exception ex)
            {
